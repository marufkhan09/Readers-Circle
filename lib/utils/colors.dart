...
class CustomColors {
  ...
  static Color red = const Color(0xFFE62B26);
  static Color black = const Color(0xFF000000);
  static Color broder = const Color(0xFFDFE2E8);
  static Color gradient_house_start = const Color(0xFFB375F0);
  static Color gradient_house_end = const Color(0xFF310B56);
  static Color gradient_member_start = const Color(0xFF003770);
  static Color gradient_member_end = const Color(0xFF7AADE0);
  static Color gradient_title_start = const Color(0xFF03037A);
  static Color gradient_title_end = const Color(0xFF5555C2);
  static Color button = const Color(0xFF0E0D8C);
  static Color grey = const Color(0xFFF8F8F8);
  static Color greyDark = const Color(0xFF818181);
  static const Color primary = Color(0xFF60371E); // Rich brown from your logo
